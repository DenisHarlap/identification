...
<body bgcolor="#bdb76b">
  ...
  <br>
  <br>
  <form name="RegistrationForm" action="/Registration_servlet">
    <table width="100%" cellspacing="0" cellpadding="4">
        ...
        <tr>
          <td><p align="right"><b>Confirm password:</b></p></td>
          <td><input type="password" size="25" maxlength="50" name="passConf"
                     value=""></td>
        </tr>
        <tr>
          <td></td>
          <td><p><input type=checkbox name="checkAdmin" value="superAdmin">
            <b>Super admin</b></p></td>
        </tr>
        <tr><td></td><td></td></tr>
        <tr>
          <td></td>
          <td> <input type="submit" name="button" value="Registrate"></td>
        </tr>
    </table>
  </form>
